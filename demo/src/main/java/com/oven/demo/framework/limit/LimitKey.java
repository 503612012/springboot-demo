package com.oven.demo.framework.limit;
...
public interface LimitKey {
    ...
    String ADVANCESALARY_INSERT_LIMIT_KEY = "com.oven.demo.core.advanceSalary.insert.limit.key";
    String ADVANCESALARY_DELETE_LIMIT_KEY = "com.oven.demo.core.advanceSalary.delete.limit.key";
